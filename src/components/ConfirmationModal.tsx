  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-6">
      ...
      <div className="relative bg-white rounded-3xl p-8 sm:p-12 max-w-lg w-full text-center shadow-2xl animate-slide-up">
        <div className="w-20 h-20 rounded-full bg-gradient-to-br from-indigo-600 to-emerald-500 text-white text-5xl flex items-center justify-center mx-auto mb-6 animate-scale-in">
          ✓
        </div>
        ...
        <button
          onClick={onClose}
          className="w-full sm:w-auto bg-indigo-600 text-white text-lg font-medium px-10 py-4 rounded-full hover:bg-indigo-700 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl"
        >
          Done
        </button>
      </div>
